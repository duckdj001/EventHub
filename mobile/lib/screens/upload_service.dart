...
class UploadService {
  ...
  Future<String> uploadImage(
    ...
    // ожидаем хотя бы: { url, publicUrl? , key? , basePublicUrl? }
    ...
    if (key != null && key.isNotEmpty) return key; // как минимум вернём ключ
    // в крайнем случае — обрежем query у url (может быть доступен анонимно)
